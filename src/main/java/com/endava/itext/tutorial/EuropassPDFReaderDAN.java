...
public class EuropassPDFReaderDAN extends EuropassPDFReader {


    private static String Europass_TITLE_NAME = "Europass";
    private static String pdfAuthor;
    private static PdfDocument pdfDocument;

    public EuropassPDFReaderDAN(String filePath) throws IOException {
        super(filePath);
    ...
    private static Set<String> extractEducation() {
        ...
        return null;
            ...
            private static boolean isEuropassPdf () {
                //TODO: implement this
                return pdfAuthor.equals(Europass_TITLE_NAME);
            }
        }
