...
public class EuropassPDFReaderSPA extends EuropassPDFReader{
     static String Europass_AUTHOR_NAME = "Europass";
     static String pdfAuthor;
     static PdfDocument pdfDocument;



    public EuropassPDFReaderSPA(String filePath) throws IOException {
        super(filePath);
